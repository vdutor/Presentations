...
## Generative modelling approximating the reverse process
...
$$
\d \v{y}_t(\m{X}) = -\frac{1}{2} \beta_t \v{y}_t(\m{X}) \d t + \sqrt{\beta_t} \d \m{W}_t
$$
...
![Reverse NDP process](figures/reverse_sde_ndp.png)
...
- Encode properties of stochastic processes (see paper)


## Conditional sampling

![Conditional sampling](figures/conditioning2.png)

## Experiment 1: Image Regression

Learning complex covariances from *data*.

::: {.r-stack}
![](figures/image_as_function_illustration_celeba_3.png){.fragment height="300"}

![](figures/image_regression.png){.fragment height="300"}
:::

## Experiment 2: 

Capturing *non-Gaussian* posteriors

::: {.r-stack}
![](figures/step_prior.png){.fragment height="300"}

![](figures/step_ndp.png){.fragment height="300"}

![](figures/step_gp.png){.fragment height="300"}
:::
